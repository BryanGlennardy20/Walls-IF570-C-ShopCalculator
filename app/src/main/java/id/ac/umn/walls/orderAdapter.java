...
public class orderAdapter extends RecyclerView.Adapter<orderAdapter.MyViewHolder> {
    ...
    orderAdapter(Activity activity, Context context, ArrayList id, ArrayList item_name, ArrayList item_price, ArrayList item_image){
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.activity_itemcart, parent, false);
